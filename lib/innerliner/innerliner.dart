...
class Innerliner extends StatefulWidget {
  @override
  _InnerlinerState createState() => new _InnerlinerState();
}

class _InnerlinerState extends State<Innerliner> {
  String code="";
  String getcode="";
...
void addData(){
  var url="http://10.0.2.2/kanban/adddatainnerliner.php";
