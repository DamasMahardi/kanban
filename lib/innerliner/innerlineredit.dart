...
class Innerlineredit extends StatefulWidget {

  final List list;
  final int index;
  Innerlineredit({this.list,this.index});
  @override
  _InnerlinereditState createState() => new _InnerlinereditState();
}

class _InnerlinereditState extends State<Innerlineredit> {
...
void editData(){
  var url="http://10.0.2.2/kanban/editdatainnerliner.php";

  http.post(url, body: {
    "idinnerliner": widget.list[widget.index]['idinnerliner'],
