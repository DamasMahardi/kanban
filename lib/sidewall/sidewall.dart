...
class Sidewall extends StatefulWidget {
  @override
  _SidewallState createState() => new _SidewallState();
}

class _SidewallState extends State<Sidewall> {
  String code="";
  String getcode="";
...
void addData(){
  var url="http://10.0.2.2/kanban/adddata.php";
