...
class Carcasssatu extends StatefulWidget {
  @override
  _CarcasssatuState createState() => new _CarcasssatuState();
}

class _CarcasssatuState extends State<Carcasssatu> {
  String code="";
  String getcode="";
...
void addData(){
  var url="http://10.0.2.2/kanban/adddatacarcasss.php";
