...
class Beltsatu extends StatefulWidget {
  @override
  _BeltsatuState createState() => new _BeltsatuState();
}

class _BeltsatuState extends State<Beltsatu> {
  String code="";
  String getcode="";
...
void addData(){
  var url="http://10.0.2.2/kanban/adddatabelt.php";
