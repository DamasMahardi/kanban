...
class Beltduaedit extends StatefulWidget {

  final List list;
  final int index;
  Beltduaedit({this.list,this.index});
  @override
  _BeltduaeditState createState() => new _BeltduaeditState();
}

class _BeltduaeditState extends State<Beltduaedit> {
