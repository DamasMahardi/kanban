...
class Beadedit extends StatefulWidget {

  final List list;
  final int index;
  Beadedit({this.list,this.index});
  @override
  _BeadeditState createState() => new _BeadeditState();
}

class _BeadeditState extends State<Beadedit> {
...
void editData(){
  var url="http://10.0.2.2/kanban/editdatabead.php";

  http.post(url, body: {
    "idbead": widget.list[widget.index]['idbead'],
