...
class Jlbedit extends StatefulWidget {

  final List list;
  final int index;
  Jlbedit({this.list,this.index});
  @override
  _JlbeditState createState() => new _JlbeditState();
}

class _JlbeditState extends State<Jlbedit> {
...
void editData(){
  var url="http://10.0.2.2/kanban/editdajlb.php";

  http.post(url, body: {
    "idjlb": widget.list[widget.index]['idjlb'],
