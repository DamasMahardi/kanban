...
class Carcassduaedit extends StatefulWidget {

  final List list;
  final int index;
  Carcassduaedit({this.list,this.index});
  @override
  _CarcassduaeditState createState() => new _CarcassduaeditState();
}

class _CarcassduaeditState extends State<Carcassduaedit> {
